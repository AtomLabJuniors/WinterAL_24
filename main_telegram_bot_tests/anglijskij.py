...
def main(us_page: int, us_obj="anglijskij"):
    url = f"https://gdz.red/8-klass/8-{us_obj}/anglijskij-yazyk-8-klass-uchebnik-vaulina/8-anglijskij-uchebnik-vaulina-page-{us_page}.html"
    head = {
        "Accept": "*/*",
...
if __name__ == "__main__":
    a = main(us_page=int(input("вводите номер упражнение:")))
    print(a)
