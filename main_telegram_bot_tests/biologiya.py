...
def main(us_parag: int, us_obj="biologiya"):
    url = f"https://gdz.red/8-klass/8-{us_obj}/biologiya-8-klass-uchebnik-pasechnik/8-biologiya-uch-pasechnik-par-{us_parag}.html"
    head = {
        "Accept": "*/*",
