...
name_textbook = "немецкий"  # Имя предмета которого вы ищете
...
name_file_in_which_textbooks_will_be_recorded = "list_obj_nemeckiy_yazik.py"  # Напишите название файлa в котором будут сохраняться найденные учебники
dictionary_that_stores_links_to_textbooks = "NEMECKIY_YAZIK"
# nemeckiy_yazik
